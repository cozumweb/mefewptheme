 ...
 * @since 3.0.0
 */
 class mefe_Flickr_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'mefe_flickr',__('['.THEMENAME.'] Flickr Widget',THEMENAME), $widget_ops );
	}
...
add_action( 'widgets_init', create_function( '', 'register_widget( "mefe_Flickr_Widget" );' ) );
