...
--------------------------------------------------------------------------------------------------*/
	...
	function _testimonial_slider2( $options )
	{
		...
		echo '<div class="'.$element_size['sizer'].'">';
			...
			echo '<div class="testimonials-carousel">';
				...
				if ( !empty ( $options['testimonials_slider_single'] ) && is_array ( $options['testimonials_slider_single'] ) ) {
					...
					echo '<ul id="testimonials_carousel" class="mefe_testimonials_carousel fixclear">';
		...
		$testimonial_slider2 = array ( 'mefe_testimonial_slider2' =>
				"
				jQuery(window).load(function() {
				// ** Testimonials carousel
				jQuery('.mefe_testimonials_carousel').carouFredSel({
					responsive: true,
		...
		mefe_update_array( $testimonial_slider2 );
