...
--------------------------------------------------------------------------------------------------*/
	...
	?>
        ...
        <div id="slideshow" class="">
			...
			<div class="container">
				...
				<div class="flexslider mefe_fancy_slider">
					<ul class="slides">
					<?php
	...
	wp_enqueue_script('flex_slider_colors');
		...
		$mefe_fancy_slider = array ( 'mefe_fancy_slider' =>
			"
				(function($) {
					$(window).load(function(){
						...
						$(\".flexslider.mefe_fancy_slider\").flexslider({
			...
			mefe_update_array( $mefe_fancy_slider );
