...
--------------------------------------------------------------------------------------------------*/
	...
	?>
		<div id="slideshow" class="<?php echo $style; ?> <?php echo $faded; ?> <?php echo $padded; ?> <?php echo $scroll; ?> " <?php echo $s_height; ?>>
			...
			<div class = "iosSlider <?php echo $faded; ?> <?php echo $wid_fixed; ?> mefe_slideshow">
						...
						foreach ( $options['single_iosslider'] as $slide ) {
							...
							echo '<div class = "item">';
								...
								if ( !empty ( $slide['io_slide_link']['url'] ) && !empty($slide['io_slide_link_image']) && $slide['io_slide_link_image'] == 'yes' ) {
									$img_link_start = '<a class="mefe_slide_image_link" href="'.$slide['io_slide_link']['url'].'" target="'.$slide['io_slide_link']['target'].'">';
									$img_link_end = '</a>';
								}
		...
		<div class="mefe_fixed_slider_fill"></div>
	...
	$ios_slider = array ( 'mefe_ios_slider' =>
			"	
