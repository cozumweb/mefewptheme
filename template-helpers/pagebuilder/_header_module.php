...
--------------------------------------------------------------------------------------------------*/
	function _header_module($options)
	{
		...
		if ( !empty ( $options['hm_header_style'] ) && $options['hm_header_style'] != 'mefe_def_header_style'  ) { 
			$style = 'uh_'.$options['hm_header_style'];
		} elseif( !empty ( $options['hm_header_style'] ) && $options['hm_header_style'] == 'mefe_def_header_style' ){
