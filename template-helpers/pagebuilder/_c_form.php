...
--------------------------------------------------------------------------------------------------*/
	...
	{	 
		...
		$contact_form = array ( 'mefe_contact_form' =>
				"
				(function($){
					$(document).ready(function() {
						$('#submit-form').click(function(e){
						
							var form = $(this).closest('.mefe_form');
							...
							$('input.mefe_required_field, textarea.mefe_required_field',form).each(function(){
								...
								else if( $(this).hasClass( 'mefe_email_field' ) && reg.test($(this).val()) == false ) {
...
");
		...
		mefe_update_array( $contact_form );
