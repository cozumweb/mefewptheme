...
--------------------------------------------------------------------------------------------------*/
                        ...
                        <div class="row">
							...
							?>
								...
								if ( !empty ( $options['sc_ec_mlid'] ) ) {
									...
									echo	'			<input type="hidden" name="mefe_list_class" class="nl-lid" value="'.$options['sc_ec_mlid'].'" />';
	...
	<?php
		...
		$mefe_event_countdown = array ( 'mefe_event_countdown' =>
			"
				var counter = {
					init: function (d)
					{
			...
			");
				...
				mefe_update_array( $mefe_event_countdown );
