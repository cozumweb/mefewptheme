...
--------------------------------------------------------------------------------------------------*/
	...
	function _circ2($options)
	{
		...
		$responsive_check = 'mefe_responsive';
		if ( $data['mefe_responsive'] == 'no' ) {
			$responsive_check = 'mefe_not_responsive';
		}
	...
	?>
        <div id="slideshow"  class="<?php echo $style; ?>">
			...
			<div class="container mefe_slideshow <?php echo $responsive_check; ?>">
	...
	<?php
		...
		$contentcarousel = array ( 'mefe_contentcarousel' =>
				"	
		...
		mefe_update_array( $contentcarousel );
