...
--------------------------------------------------------------------------------------------------*/
	...
	function _image_box($options)
	{
		...
		$link_start = '<span class="mefe_image_box_cont">';
		$link_end = '</span>';
		$image = '';
		$title = '';
		$text = '';
		...
		{ 
			$mefe_style = 'imgboxes_style1 mefe_ib_style2';
			...
			if ( !empty($options['image_box_link']['url']) ) {
				...
				$link_start = '<span class="mefe_image_box_cont alignright">';
				$link_end = '</span>';
			}

			
			echo '<div class="'.$element_size['sizer'].' box image-boxes '.$mefe_style.'">';
