...
--------------------------------------------------------------------------------------------------*/
	...
	function _icarousel($options)
	{
		...
		if ( isset ( $options['ic_header_style'] ) && !empty ( $options['ic_header_style'] ) && $options['ic_header_style'] != 'mefe_def_header_style' ) { 
	...
	wp_enqueue_script('raphael_min');
					...
					$icarousel = array ( 'mefe_icarousel_slider' =>
							"	
