							...
							<div class="span5">
								<div class="fancy_register_form">
                                	<h4 style="text-align:center"><?php _e("Create <strong>your account</strong> now",THEMENAME);?></h4>
										<form id="register_form_static" name="login_form" method="post" class="mefe_form_login" action="<?php echo site_url('wp-login.php?action=register', 'login_post') ?>">
	                                    	<div>
											...
											<div style="margin-bottom:0;">
												<input type="submit" id="signup" name="submit" class="mefe_sub_button btn btn-danger"  value="<?php _e("REGISTER",THEMENAME);?>">
											</div>
											<input type="hidden" value="register" class="" name="mefe_form_action">
											<input type="hidden" value="mefe_do_login" class="" name="action">
											<input type="hidden" value="<?php echo $_SERVER['PHP_SELF'] ?>" class="mefe_login_redirect" name="submit">
											<div class="links"></div>
										</form>
                                </div>
							</div>
