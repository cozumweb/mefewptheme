...
--------------------------------------------------------------------------------------------------*/
	...
	{	
		...
		if ( isset ( $options['ps_header_style'] ) && !empty ( $options['ps_header_style'] ) && $options['ps_header_style'] != 'mefe_def_header_style' ) { 
	...
	?>
        ...
        <div id="slideshow" class="gradient <?php echo $style; ?>">
			...
			<div class="portfolio-slider-frames <?php echo $hclass;?> mefe_slideshow">
	...
	<?php
					...
					if ( $options['ps_sliding_direction'] == 'Vertical' ) {
						$mefe_portfolio_slider = array ( 'mefe_portfolio_slider' =>
							"
							(function($){
								var left = {
										imgFront	: 365,
						...
						");
							...
							mefe_update_array( $mefe_portfolio_slider );
