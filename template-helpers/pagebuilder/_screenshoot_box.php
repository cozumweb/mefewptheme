...
--------------------------------------------------------------------------------------------------*/
	...
	function _screenshoot_box( $options )
	{
		...
		<div class="span12">
			<div class="screenshot-box fixclear">
				<div class="thescreenshot">
					...
					<ul id="screenshot-carousel" class="fixclear mefe_screenshot-carousel">
					<?php
		...
		$screenshoot_box = array ( 'mefe_screenshoot_box' =>
				"jQuery(window).load(function() {
						// ** Screenshots carousel
						jQuery('.mefe_screenshot-carousel').carouFredSel({
							responsive: true,
		...
		mefe_update_array( $screenshoot_box );
