...
Subtitle
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_subtitle( $atts, $content = null ) {
	// [subtitle] Content [/subtitle]
	
	return '<h2 class="subtitle">' . do_shortcode($content) . '</h2>';
	
}
add_shortcode('subtitle', 'mefe_shortcode_subtitle');
/*--------------------------------------------------------------------------------------------------
	SITEMAP
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_sitemap( $atts ) {
...
add_shortcode('sitemap', 'mefe_shortcode_sitemap');
/*--------------------------------------------------------------------------------------------------
	Skills
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_skills( $atts, $content = null ) {
...
function mefe_shortcode_skill( $atts, $content = null ) {
...
add_shortcode('skills', 'mefe_shortcode_skills');
add_shortcode('skill', 'mefe_shortcode_skill');
/*--------------------------------------------------------------------------------------------------
	H1 Alternative
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_h1a( $atts, $content = null ) {
	// [h1a] Content [/h1a]
	
	return '<h1 class="m_title">' . do_shortcode($content) . '</h1>';
	
}
add_shortcode('h1a', 'mefe_shortcode_h1a');
/*--------------------------------------------------------------------------------------------------
	H2 Alternative
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_h2a( $atts, $content = null ) {
	// [h2a] Content [/h2a]
	
	return '<h2 class="m_title">' . do_shortcode($content) . '</h2>';
	
}
add_shortcode('h2a', 'mefe_shortcode_h2a');
/*--------------------------------------------------------------------------------------------------
	H3 Alternative
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_h3a( $atts, $content = null ) {
	// [h3a] Content [/h3a]
	
	return '<h3 class="m_title">' . do_shortcode($content) . '</h3>';
	
}
add_shortcode('h3a', 'mefe_shortcode_h3a');
/*--------------------------------------------------------------------------------------------------
	H4 Alternative
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_h4a( $atts, $content = null ) {
	// [h4a] Content [/h4a]
	
	return '<h4 class="m_title">' . do_shortcode($content) . '</h4>';
	
}
add_shortcode('h4a', 'mefe_shortcode_h4a');
/*--------------------------------------------------------------------------------------------------
	H5 Alternative
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_h5a( $atts, $content = null ) {
	// [h5a] Content [/h5a]
	
	return '<h5 class="m_title">' . do_shortcode($content) . '</h5>';
	
}
add_shortcode('h5a', 'mefe_shortcode_h5a');
/*--------------------------------------------------------------------------------------------------
	H6 Alternative
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_h6a( $atts, $content = null ) {
	// [h6a] Content [/h6a]
	
	return '<h6 class="m_title">' . do_shortcode($content) . '</h6>';
	
}
add_shortcode('h6a', 'mefe_shortcode_h6a');
/*--------------------------------------------------------------------------------------------------
	List styles
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_list( $atts, $content = null ) {
...
add_shortcode('list', 'mefe_shortcode_list');
/*--------------------------------------------------------------------------------------------------
	Blockquote
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_blockquote( $atts, $content = null ) {
...
add_shortcode('blockquote', 'mefe_shortcode_blockquote');
/*--------------------------------------------------------------------------------------------------
	QR CODE
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_qr( $atts, $content = null ) {
...
add_shortcode('qr', 'mefe_shortcode_qr');

/*--------------------------------------------------------------------------------------------------
	Two Columns
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_two_columns( $atts, $content = null ) {
	// [one_half_column] Content [/one_half_column]
	  
	return '<div class="span6">' . do_shortcode($content) . '</div>';
	
}
add_shortcode('one_half_column', 'mefe_shortcode_two_columns');
/*--------------------------------------------------------------------------------------------------
	1/3 Columns
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_three_columns( $atts, $content = null ) {
	// [one_third_column] Content [/one_third_column]
		  
	return '<div class="span4">' . do_shortcode($content) . '</div>';
	
}
add_shortcode('one_third_column', 'mefe_shortcode_three_columns');

/*--------------------------------------------------------------------------------------------------
	1/4 Columns
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_one_fourth_columns( $atts, $content = null ) {
	// [one_fourth_column] Content [/one_fourth_column]
		  
	return '<div class="span3">' . do_shortcode($content) . '</div>';
	
}
add_shortcode('one_fourth_column', 'mefe_shortcode_one_fourth_columns');
/*--------------------------------------------------------------------------------------------------
	2/3 Columns
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_two_third_columns( $atts, $content = null ) {
	// [two_third_column] Content [/two_third_column]
		  
	return '<div class="span8">' . do_shortcode($content) . '</div>';
	
}
add_shortcode('two_third_column', 'mefe_shortcode_two_third_columns');
/*--------------------------------------------------------------------------------------------------
	3/4 Columns
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_three_fourth_columns( $atts, $content = null ) {
	// [three_fourth_column] Content [/three_fourth_column]
	  
	return '<div class="span9">' . do_shortcode($content) . '</div>';
	
}
add_shortcode('three_fourth_column', 'mefe_shortcode_three_fourth_columns');
/*--------------------------------------------------------------------------------------------------
	ROW
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_row( $atts, $content="" ) {
...
add_shortcode('row', 'mefe_shortcode_row');/*--------------------------------------------------------------------------------------------------
	Accordion
--------------------------------------------------------------------------------------------------*/
function mefe_accordion( $atts, $content = null ) {
...
add_shortcode('accordion', 'mefe_accordion');

/*--------------------------------------------------------------------------------------------------
	ToolTip
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_tooltip( $atts, $content=null ) {
...
add_shortcode('tooltip', 'mefe_shortcode_tooltip');

/*--------------------------------------------------------------------------------------------------
	Icons
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_icons( $atts, $content=null ) {
...
add_shortcode('icon', 'mefe_shortcode_icons');


/*--------------------------------------------------------------------------------------------------
	TABLES styles
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_table( $atts, $content = null ) {
...
add_shortcode('table', 'mefe_shortcode_table');

/*--------------------------------------------------------------------------------------------------
	Buttons
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_buttons( $atts, $content=null ) {
...
add_shortcode('button', 'mefe_shortcode_buttons');
...
$columns = '';
$color = '';
function mefe_shortcode_pricing_table( $atts, $content=null ) {
...
add_shortcode('pricing_table', 'mefe_shortcode_pricing_table');


function mefe_shortcode_pricing_column( $atts, $content=null ) {
...
add_shortcode('pricing_column', 'mefe_shortcode_pricing_column');

function mefe_shortcode_pricing_caption( $atts, $content=null ) {
...
add_shortcode('pricing_caption', 'mefe_shortcode_pricing_caption');


/*--------------------------------------------------------------------------------------------------
	TABS
--------------------------------------------------------------------------------------------------*/
  function mefe_shortcode_tabs($atts, $content = null) {
  ...
  function mefe_shortcode_tab($atts, $content = null) {
  ...
  add_shortcode('tabs', 'mefe_shortcode_tabs');
  add_shortcode('tab', 'mefe_shortcode_tab');


/*--------------------------------------------------------------------------------------------------
	SHOW CODE
--------------------------------------------------------------------------------------------------*/
function mefe_shortcode_code( $atts, $content=null ) {
...
add_shortcode('code', 'mefe_shortcode_code');
?>