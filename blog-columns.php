		 ...
		 <div class="itemListView clearfix eBlog">
			...
			if ( have_posts() ) :
				while( have_posts() ){
					...
					$image_size = mefe_get_size( 'span'.$columns_size );
					...
					elseif ( $data['mefe_use_first_image'] == 'yes') {
					...
					<div class="itemContainer mefe_columns mefe_columns<?php echo $data['blog_style_layout'];?> post-<?php the_ID(); ?> span<?php echo $columns_size;?>"> 
						<?php echo $image; ?>
