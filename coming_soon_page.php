		...
		<div class="content">
			...
			<?php
				...
				if ( !empty ( $data['cs_lsit_id'] ) && !empty ( $data['mailchimp_api'] ) ) {
					...
					echo	'			<input type="text" name="mefe_mc_email" class="nl-email" value="" placeholder="your.address@email.com" />';
					echo	'			<input type="hidden" name="mefe_list_class" class="nl-lid" value="'.$data['cs_lsit_id'].'" />';
