...
add_filter('woocommerce_get_price_html', 'mefe_woocommerce_price_html');

function mefe_woocommerce_free_price_html($content){   
...
add_filter('woocommerce_free_price_html', 'mefe_woocommerce_free_price_html');
