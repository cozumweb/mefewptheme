<?php
	...
	$extra_options = array();
	$mefe_meta_elements = array();

/*--------------------------------------------------------------------------------------------------
	SET-UP META TYPES
--------------------------------------------------------------------------------------------------*/
	$mefe_meta_types = array( 
						...
						"subelements" => array 
										(
											...
											array( 
												...
												"type" => "media",
												"alt" => true,
												"class" => "mefe_hide_me port_media_type-combined"
											),
											array( 
												"name" => "Video URL",
										...
										( 
											...
											(
												...
												"area_options" => array (
																...
																'_mefe_doc_header'=>'Documentation Header' ,
																)
											),
											...
											(
												...
												"area_options" => array (
																...
																'_mefe_documentation' => 'Documentation',
																'_mefe_sidebar' => 'Sidebar',
																)
											),
						...
						"subelements" => array 
										(
											...
											array( 
												...
												"type" => "select",
												"std" => "style1",
												"options" => array ( 'mefe_fill_class' => 'Normal', 'centered' => 'Centered'  ),
											),
											array
											( 
												"name" => "Icon",
						...
						"subelements" => array 
											(
												...
												array( 
													...
													"std" => "",
													"type" => "select",
													"options" => array( "mefe_def_anim_pos"=>"From Left" ,"fromright"=>"From Right" ),
													"class" => ""
												)
